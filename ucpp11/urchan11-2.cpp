#include <iostream>
#include <array>
int max3(/*parameter 仮引数*/int a, int b, int c){
    int m = a;
    if(b>m){
        m = b;
    }
...
int main(){
    ...
    int highest_math = max3(/*argument 引数*/math[0],math[1],math[2]);
    int highest_eng = max3(eng[0],eng[1],eng[2]);//関数呼び出し function call
